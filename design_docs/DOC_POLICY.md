...
## Local addendum — Turnstone

This policy was founded 2026-08-24, when the canonical core was distributed
across the workspace. Turnstone had 28 documents in `design_docs/` and no policy.
...
Core §6 was satisfied on 2026-08-26 by establishing
`design_docs/DOC_README.md` as the canonical index.
